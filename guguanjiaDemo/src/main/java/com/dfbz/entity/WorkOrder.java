...
public class WorkOrder {
    ...
    @Transient
    private String createName;//发起工单用户名

    @Transient
    private String transportName;//转运用户名

    @Transient
    private String recipientName;//处理工单用户名

    @Transient
    private String createPhone;//发起工单用户电话

    @Transient
    private String transportPhone;//转运用户电话

    @Transient
    private String recipientPhone;//处理工单用户电话

    @Transient
    private String createOfficeName;//发起工单用户公司名字

    @Transient
    private String transportOfficeName;//转运用户公司名字

    @Transient
    private String recipientOfficeName;//发起工单用户公司名字
